              ...
              <div className="mt-[370px]">
                <div className="bg-white p-4 sm:p-8 rounded-t-2xl flex flex-col items-center  ">
                  ...
                  <p className="mt-4 leading-7 text-gray-500">
                    ...
                    optical nature) are mathematically intersected to produce the 3-dimensional coordinates of the
                    points of interest.
                  </p>
                  <br />
        ...
        <div class="w-screen  mt-40 mb-44 h-full  mx-auto   overflow-hidden flex justify-center items-center ">
          <div class="md:flex 2xl:mx-80 xl:mx-40 lg:mx-20 md:mx-0 h-[700px] bg-white rounded-xl shadow-md">
            <div class="  md:w-2/5 w-full">
              <img class="h-full w-full object-cover rounded-2xl " src="/img/photo.png" alt="Contact" />
            </div>
            <div class="p-8  md:w-3/5 w-full h-full flex flex-col justify-center">
              ...
              <p className="mt-4 leading-7 text-gray-500">
                Photogrammetry, as its name implies, is a 3-dimensional coordinate measuring technique that uses
                photographs as the fundamental medium for metrology (or measurement). The fundamental principle used by
                Photogrammetry is triangulation or more specifically called Aerial Triangulation. By taking photographs
                from at least two different locations, so-called “lines of sight” can be developed from each camera to
