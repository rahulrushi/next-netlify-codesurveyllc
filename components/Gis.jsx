                ...
                <div className="mt-[370px]">
                  <div className="bg-white p-4 sm:p-8 rounded-t-2xl flex flex-col items-center  ">
                    ...
                    <p className="first-letter:text-4xl first-letter:font-bold  text-justify indent-14 mt-4 leading-7 text-gray-500">
                      ...
                      includes removing distortions in the images (georectification, Orthorectification) and ensuring
                      that the output is of high quality in terms of clarity, resolution and colour. The processing
                      consists of georeferencing images, Orthorectification, mosaicing, colour balancing, and cutting to
                      specified output formats. Code Survey is able to produce a seamless raster data product from
                      multiple image tiles. <br /> Handling large volumes of images, automating many of the data
                      management processes in this activity, and is able to pass on the gains in productivity to the
                      client in terms of fast turnaround.
                    </p>
                    <br />
                  </div>
                </div>
                ...
                <div className="mt-[370px]">
                  <div className="bg-white p-4 sm:p-8 rounded-t-2xl flex flex-col items-center  ">
                    ...
                    <p className="first-letter:text-4xl first-letter:font-bold  text-justify indent-14 mt-4 leading-7 text-gray-500">
                      ...
                      for easy identification of where a specific property is located relative to adjacent properties
                      and public roadways.
                      <br />
                      <br />
                      <span>
                        Parcel data is derived from existing maps (scans or hard copies) and legal information by
                        geospatially registering imagery using a heads-up digitizing technique. Parcels also can be
                        collected by employing COGO methods to enter the legal meets and bounds. These parcel mapping
              ...
              >
                <div className="mt-[370px]">
                  <div className="bg-white p-4 sm:p-8 rounded-t-2xl flex flex-col items-center  ">
                    ...
                    <p className="first-letter:text-4xl first-letter:font-bold  text-justify indent-14 mt-4 leading-7 text-gray-500">
                      Associating the image with the coordinate system or as per photo image requirement of the client.
                      We work on supplied images like historic maps and satellite images on which we can digitize and
                      update the information as per requirement.
                    </p>
                    <br />
                  </div>
                </div>
                ...
                <div className="mt-[370px]">
                  <div className="bg-white p-4 sm:p-8 rounded-t-2xl flex flex-col items-center  ">
                    ...
                    <p className="first-letter:text-4xl first-letter:font-bold  text-justify indent-14 mt-4 leading-7 text-gray-500">
                      ...
                      imagery and derives land resource. It is used in the fields of urban planning, land management,
                      and natural resource conservation. Changes in land use and land cover are regular, rapid, and so
                      can have significant impacts for people, the economy, and the environment. Complete assessment of
                      vacant land for the development activities.
                    </p>
                    <br />
              ...
              <div className="md:flex 2xl:mx-80 xl:mx-40 lg:mx-20 md:mx-0 h-[700px] bg-white rounded-xl shadow-md">
                ...
                <div className="p-8  md:w-3/5 w-full h-full flex flex-col justify-center">
                  ...
                  <p className="first-letter:text-4xl first-letter:font-bold  text-justify indent-14 mt-4 leading-7 text-gray-500">
                    ...
                    tiles. <br /> <br /> Handling large volumes of images, automating many of the data management
                    processes in this activity, and is able to pass on the gains in productivity to the client in terms
                    of fast turnaround.
                  </p>
                </div>
              </div>
